...
class MakeAuthCommand extends Command {
  ...
  public function fire() {
    ...
    if (!$this->option('views')) {
      ...
      copy(
              __DIR__ . '/stubs/make/controllers/HomeController.stub', app_path('Http/Controllers/HomeController.php')
      );

      $this->info('Updated Routes File.');

      file_put_contents(
              app_path('Http/routes.php'), file_get_contents(__DIR__ . '/stubs/make/routes.stub'), FILE_APPEND
      );
    }
