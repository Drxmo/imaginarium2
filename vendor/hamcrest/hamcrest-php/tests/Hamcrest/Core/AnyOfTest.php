...
class AnyOfTest extends \Hamcrest\AbstractMatcherTest {
  ...
  public function testAnyOfSupportsMixedTypes() {
    $combined = anyOf(
            equalTo(new \Hamcrest\Core\SampleBaseClass('good')), equalTo(new \Hamcrest\Core\SampleBaseClass('ugly')), equalTo(new \Hamcrest\Core\SampleSubClass('good'))
    );
  ...
  public function testAnyOfHasAReadableDescription() {
    $this->assertDescription(
            '("good" or "bad" or "ugly")', anyOf('good', 'bad', 'ugly')
    );
  }
  ...
  public function testNoneOfHasAReadableDescription() {
    $this->assertDescription(
            'not ("good" or "bad" or "ugly")', noneOf('good', 'bad', 'ugly')
    );
  }
