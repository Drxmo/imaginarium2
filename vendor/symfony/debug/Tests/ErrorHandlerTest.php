  ...
  public function testErrorStacking() {
    try {
      ...
      $logger
              ...
              ->method('log')
              ->withConsecutive(
                      array($this->equalTo(LogLevel::WARNING), $this->equalTo('Dummy log')), array($this->equalTo(LogLevel::DEBUG), $this->equalTo('Silenced warning'))
              )
      ;
  ...
  public function testHandleFatalErrorOnHHVM() {
    try {
      ...
      $logger
              ...
              ->method('log')
              ->with(
                      $this->equalTo(LogLevel::CRITICAL), $this->equalTo('Fatal Error: foo'), $this->equalTo(array(
                          'type' => 1,
                          'file' => 'bar',
                          'line' => 123,
                          'level' => -1,
